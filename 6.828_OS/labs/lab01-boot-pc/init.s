...
.LC3:
	...
	.align 8
.LC4:
	.string	"Lab1-Ch: \033[1;4;31;43mHello colorful world! \033[0m\n"
	.text
	.p2align 4
...
.LM44:
	...
	.p2align 3
.L20:
	.stabn	68,0,88,.LM45-.LFBB3
.LM45:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L20
.L23:
	.stabn	68,0,74,.LM46-.LFBB3
.LM46:
...
.LM49:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,79,.LM50-.LFBB3
.LM50:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,80,.LM51-.LFBB3
.LM51:
	leaq	.LC5(%rip), %rdi
	.stabn	68,0,79,.LM52-.LFBB3
.LM52:
	movq	%rax, 16(%rsp)
	.stabn	68,0,80,.LM53-.LFBB3
.LM53:
	xorl	%eax, %eax
...
.LM55:
	call	cprintf@PLT
	.stabn	68,0,81,.LM56-.LFBB3
.LM56:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,82,.LM57-.LFBB3
.LM57:
	leaq	.LC6(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM61:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,97,.LM62-.LFBB4
.LM62:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,98,.LM63-.LFBB4
.LM63:
	leaq	.LC7(%rip), %rdi
	.stabn	68,0,97,.LM64-.LFBB4
.LM64:
	movq	%rax, 16(%rsp)
	.stabn	68,0,98,.LM65-.LFBB4
.LM65:
	xorl	%eax, %eax
...
.LM67:
	call	cprintf@PLT
	.stabn	68,0,99,.LM68-.LFBB4
.LM68:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,100,.LM69-.LFBB4
.LM69:
	xorl	%eax, %eax
	leaq	.LC6(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,102,.LM70-.LFBB4
.LM70:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
